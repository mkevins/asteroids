(function () {
  ...
  Game.NUM_ASTEROIDS = 10;
	...
	Game.backgroundImages = [
		"./assets/heic0502a.jpg",
		"./assets/potw1809a.jpg",
		"./assets/potw1810a.jpg",
		"./assets/potw1813a.jpg",
		"./assets/potw1814a.jpg",
		"./assets/potw1815a.jpg",
		"./assets/potw1818a.jpg",
		"./assets/potw1820a.jpg",
		"./assets/potw1821a.jpg"
	];

	// preload
	Game.backgroundImages.forEach(image => (new Image()).src = image);
  ...
  Game.prototype.relocate = function () {
    this.ship.pos = Vector.randomInner();
    this.ship.vel = new Vector({ x: 0, y: 0});
    this.ship.powerup({type: 'shield'});
  };
  ...
  Game.prototype.draw = function (context) {
    //context.drawImage(this.image, 0, 0);
		context.save();
		context.scale(context.canvas.width / this.dimX, context.canvas.height / this.dimY);
  ...
  Game.prototype.drawStats = function (context) {
    ...
    for (var i = 0; i < this.livesCount - 1; i++) {
      ...
      context.drawImage(Ship.image[0], 0, 0);
    };
    context.restore();
  };
  ...
  Game.prototype.reapers = function () {
	...
	Game.prototype.showImage = function () {
		var i = this.level % Game.backgroundImages.length;
		var image = Game.backgroundImages[i];
		var url = `url('${image}')`;
